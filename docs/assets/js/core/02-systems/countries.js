/* =============================================================================
   ...
   03) COUNTRY AND REGION REGISTRY
   03A) COUNTRY CODE REGISTRY
   03B) NORMALIZED COUNTRY DATA HELPERS
   04) GLOBAL DATA EXPOSURE
   05) COUNTRY REGION BUILD
   06) SHARED READINESS HELPERS
   07) INITIALIZATION
   08) FRAGMENT-MOUNTED REBUILD
   09) END OF FILE
============================================================================= */
...
/* =============================================================================
   01) MODULE IDENTITY
============================================================================= */
/* /website/docs/assets/js/core/02-systems/countries.js */

(function () {
  const MODULE_PATH = '/website/docs/assets/js/core/02-systems/countries.js';

  /* =============================================================================
     02) MODULE REGISTRATION
  ============================================================================= */
  const SYSTEM_ID = 'core-countries';
  ...
  window.ARTAN_I18N_COUNTRIES_DATA = NORMALIZED_COUNTRIES_DATA;
  window.ARTAN_I18N_COUNTRY_CODE_REGISTRY = COUNTRY_CODE_REGISTRY;
  window.NEUROARTAN_COUNTRIES_DATA = NORMALIZED_COUNTRIES_DATA;
  window.NEUROARTAN_COUNTRY_CODE_REGISTRY = COUNTRY_CODE_REGISTRY;

  window.NeuroartanCountries = Object.freeze({
    systemId: SYSTEM_ID,
    modulePath: MODULE_PATH,
    countries: NORMALIZED_COUNTRIES_DATA,
    countryCodeRegistry: COUNTRY_CODE_REGISTRY,
    rebuild: buildCountryRegions
  });

  /* =============================================================================
     03A) DATA READINESS EVENT
  ============================================================================= */
  document.dispatchEvent(
    new CustomEvent('neuroartan:i18n-countries-ready', {
      detail: {
        modulePath: MODULE_PATH,
        regions: NORMALIZED_COUNTRIES_DATA.length
      }
    })
  );
  ...
  /* =============================================================================
     07) INITIALIZATION
  ============================================================================= */
  window.__artanRunWhenReady(buildCountryRegions);
