...
(() => {
  ...
  const SCENE_SELECTOR = '[data-about-featured-functions-scene]';
  const LIFECYCLE_BOUND_ATTRIBUTE = 'data-about-featured-functions-shader-bound';
  ...
  class FeaturedFunctionShaderScene {
    ...
    mount() {
      if (!window.NeuroShaderCore || typeof window.NeuroShaderCore !== 'function') {
        console.warn('[about-featured-functions-shader] NeuroShaderCore is unavailable.');
        return;
      }
